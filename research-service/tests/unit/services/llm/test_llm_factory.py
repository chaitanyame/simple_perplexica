...
class TestLLMFactory:
    ...
    def test_create_client_for_openrouter(self):
        ...
        with patch("src.services.llm.llm_factory.OpenRouterClient") as mock_client:
            ...
            assert call_kwargs["model"] == "deepseek/deepseek-r1:free"
    ...
    def test_create_client_uses_correct_model(self):
        ...
        with patch("src.services.llm.llm_factory.OpenRouterClient") as mock_client:
            ...
            call_kwargs = mock_client.call_args.kwargs
            assert call_kwargs["model"] == "google/gemini-2.0-flash-thinking-exp:free"
...
class TestLLMFactoryHelpers:
    ...
    def test_get_research_llm_returns_deepseek_r1_client(self):
        """Test get_research_llm returns DeepSeek R1 client."""
        with patch("src.services.llm.llm_factory.OpenRouterClient") as mock_client:
            mock_instance = MagicMock()
            mock_client.return_value = mock_instance
